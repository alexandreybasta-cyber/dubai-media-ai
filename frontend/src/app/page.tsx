    ...
    <div className="max-w-6xl mx-auto">
      ...
      <div className="mb-12">
        {tools.map((tool) => (
          <div
            key={tool.name}
            className="max-w-2xl mx-auto rounded-xl border border-gray-100 border-l-4 border-l-orange-500 bg-white p-8 shadow-lg transition-all hover:shadow-xl flex flex-col"
          >
            <div className="inline-flex p-3 rounded-lg bg-orange-50 text-orange-600 w-fit">
            ...
            <div className="mt-6 flex justify-center">
              <Link
                href={tool.href}
                className="inline-flex items-center gap-2 px-6 py-2.5 rounded-lg bg-orange-500 text-sm font-medium text-white hover:bg-orange-600 transition-colors shadow-sm"
              >
